...
cp -r `find third_party/connectedhomeip/ -maxdepth 1 -name '.*' | grep -v '\.environment$' | grep -v .'git$'` dist/cores/nRF5/nordic/external/connectedhomeip/
#cp third_party/connectedhomeip/* dist/cores/nRF5/nordic/external/connectedhomeip/
cp -r `find third_party/connectedhomeip/ -maxdepth 1 -type f`  dist/cores/nRF5/nordic/external/connectedhomeip/
...
cp -rfp third_party/connectedhomeip/third_party/openthread/repo/src/core/config/ dist/cores/nRF5/nordic/external/openthread/include/
cp -rfp third_party/connectedhomeip/third_party/openthread/repo/examples/platforms/utils/*.h dist/cores/nRF5/nordic/external/openthread/include/openthread/platform/utils/
cp -rfp third_party/connectedhomeip/third_party/openthread/repo/examples/platforms/openthread-system.h dist/cores/nRF5/nordic/external/openthread/include/openthread/platform/
